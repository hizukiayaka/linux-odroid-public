 ...
 * General commands:
 *
 *  left-top/right-bottom (source/destination/mask)
 ...
 *  blend function, round mode
 *  bitblt command and start
 *
 * TODO: rotate_reg, clipping_window
 *
 * Command stream formatting:
 *
 * The left-top and right-bottom commands have to come in pairs
 * (left-rop first, followed by right-bottom).
 *
